 ...
 * CLI version: 2.9.1
 *
 * Generated: Mon, 31 Oct 2022 10:31:44 GMT
 */

var APP_com_domain_app_lightninapptest = (function () {
  'use strict';
  ...
  class App extends Lightning$1.Component {
    constructor() {
      super(...arguments);
      _defineProperty(this, "_starAnimation", void 0);
      _defineProperty(this, "Background", this.getByRef("Background"));
      _defineProperty(this, "Star", this.Background.getByRef("Star"));
      _defineProperty(this, "_starAnimationStoped", undefined);
    }
    static _template() {
      ...
      return {
        Background: {
          ...
          Star: {
            ...
            type: Star,
            shader: {
              type: Lightning$1.shaders.Perspective,
              rx: rotate0
            }
          },
          Pentagon: {
    ...
    _init() {
      ...
      this._setState("Star");
      (_this$_starAnimation = this._starAnimation) === null || _this$_starAnimation === void 0 ? void 0 : _this$_starAnimation.start();
    }

    //State (focus) of the componets and their connections
    static _states() {
      return [class Star extends this {
        _getFocused() {
          var _this$_starAnimation2;
          (_this$_starAnimation2 = this._starAnimation) === null || _this$_starAnimation2 === void 0 ? void 0 : _this$_starAnimation2.resume();
          return this.tag("Background.Star");
        }
        _handleRight() {
          var _this$_starAnimation3;
          this._setState("Pentagon");
          (_this$_starAnimation3 = this._starAnimation) === null || _this$_starAnimation3 === void 0 ? void 0 : _this$_starAnimation3.pause();
        }
  ...
  class Pentagon extends Lightning$1.Component {
    _focus() {
  ...
  class Elipse extends Lightning$1.Component {
    _focus() {
  ...
  class Star extends Lightning$1.Component {
    _focus() {
